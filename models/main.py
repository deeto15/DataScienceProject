...
def main():
    ...
    _, X_full_test, _, y_full_test = train_test_split(full_X, full_y, stratify=full_y, test_size=0.2, random_state=42)
    ...
    lr_model, X_test_lr, y_test_lr, w_test_lr = pp.training_logistic_regression(upweighted)
